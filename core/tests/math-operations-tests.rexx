...
/*
 * @test-tags math, basic, arithmetic
 * @description Mathematical operations testing with multiple describe blocks
 * 
...
IF target_describe = "all" THEN DO
  CALL BasicArithmeticTests
  CALL AdvancedMathTests
  CALL EdgeCaseTests
  CALL ConstantValidationTests
END
ELSE DO
