/**
 * Podman Container Handler Tests
 * 
 * Tests for podman container management with heavy mocking
 * to simulate podman infrastructure on any system
 * 
...
describe('Podman Container Handler', () => {
  let handler;
  let mockSpawn;
  let mockFs;
