...
['address-ssh.js', 'address-remote-docker.js', 'address-docker.js', 'address-podman.js', 'address-nspawn.js'].forEach(f => {
...
function BUNDLED_CONTAINER_HANDLERS_META() {
  return {
    type: 'bundle',
    name: 'Bundled Provisioning and Orchestration Handlers',
    provides: { bundleHandlers: ['ssh', 'remote_docker', 'docker', 'podman', 'nspawn'] },
    dependencies: {},
    envVars: []
  };
}
