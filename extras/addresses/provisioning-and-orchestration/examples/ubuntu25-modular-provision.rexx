...
-- Usage: node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-modular-provision.rexx HOST USER [REXX_BIN]
...
LET DOCKER_RESULT = ADDRESS('SYSTEM', 'cd /home/paul/scm/rexxjs/RexxJS && node core/src/cli.js extras/addresses/provisioning-and-orchestration/modules/docker-install.rexx ' || HOST || ' ' || USER || ' docker-provision')
...
LET NODEJS_RESULT = ADDRESS('SYSTEM', 'cd /home/paul/scm/rexxjs/RexxJS && node core/src/cli.js extras/addresses/provisioning-and-orchestration/modules/nodejs-install.rexx ' || HOST || ' ' || USER || ' nodejs-provision')
...
LET DEPLOY_RESULT = ADDRESS('SYSTEM', 'cd /home/paul/scm/rexxjs/RexxJS && node core/src/cli.js extras/addresses/provisioning-and-orchestration/modules/rexxjs-deploy.rexx ' || HOST || ' ' || USER || ' ' || REXX_BIN || ' rexxjs-provision')
