...
ADDRESS ssh
copy_to id=nspawn-deploy local='./extras/addresses/provisioning-and-orchestration/examples/nspawn-web-local.rexx' remote='/tmp/nspawn-web-local.rexx' timeout=10000
