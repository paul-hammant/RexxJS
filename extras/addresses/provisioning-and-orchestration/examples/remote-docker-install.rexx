...
ADDRESS ssh
copy_to id=docker-install local='./extras/addresses/provisioning-and-orchestration/examples/install-docker-local.rexx' remote='/tmp/install-docker-local.rexx' timeout=10000
