...
-- Usage: node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx HOST USER [REXX_BIN]
...
IF HOST = '' THEN DO
  ...
  SAY ''
  SAY 'Usage Options:'
  SAY '  node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx HOST USER [REXX_BIN]'
  SAY '  ./bin/rexx extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx HOST USER [REXX_BIN]'
  SAY ''
  SAY 'Parameters:'
  ...
  SAY ''
  SAY 'Example:'
  SAY '  node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx 192.168.1.100 ubuntu'
  EXIT 1
END
...
IF USER = '' THEN DO
  ...
  SAY '  node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx ' || HOST || ' USERNAME'
  SAY ''
  SAY 'Example:'
  SAY '  node core/src/cli.js extras/addresses/provisioning-and-orchestration/ubuntu25-final.rexx ' || HOST || ' ubuntu'
  EXIT 1
END
