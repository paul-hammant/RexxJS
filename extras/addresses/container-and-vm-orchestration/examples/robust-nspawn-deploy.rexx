...
ADDRESS ssh
copy_to id=robust-deploy local='./extras/addresses/container-and-vm-orchestration/examples/robust-nspawn-web-local.rexx' remote='/tmp/robust-nspawn-web-local.rexx' timeout=10000
