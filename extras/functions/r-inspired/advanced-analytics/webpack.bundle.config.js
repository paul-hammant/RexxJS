...
module.exports = {
  ...
  entry: path.resolve(__dirname, 'src/r-regression-functions.js'),
  output: {
    filename: 'r-regression-functions.bundle.js',
    path: path.resolve(getGitRoot(), '../dist/functions'),
    library: 'r-regression-functions',
    libraryTarget: 'umd',
    globalObject: 'this'
  },
  externals: {
  ...
  plugins: [
    ...
    new (require('webpack')).BannerPlugin({
      banner: '/*!\n * @rexxjs-meta=R_REGRESSION_FUNCTIONS_META\n */',
      raw: true
    })
  ]
};
